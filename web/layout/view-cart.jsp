...
<body>
    ...
    <%
        Vector<Cart> carts = new Cart().findCartUser(Integer.parseInt(user_id));
    %>
    ...
    <%
        ...
        <a class="btn btn-primary" href="/web-project-theory/web/layout/manage-product.jsp" role="button">Product List</a>
        <a class="btn btn-success" href="/web-project-theory/web/layout/manage-transaction.jsp" role="button">View Transaction List</a>
	...
	<div class="container-fluid">
		<div class="mt-4">
			<h3 class="text-info" style="font-size:30px; font-weight: lighter;">My Cart</h3>
		</div>
        ...
        <div class="text-center">
            ...
            <a class="btn btn-danger btn-md text-white" role="button" href="/web-project-theory/web/controller/CartController/DeleteUserCart.jsp">Empty Cart</a>
            <a class="btn btn-info btn-md text-white" role="button" href="/web-project-theory/web/controller/CartController/UpdateUserCart.jsp?statusCart=Pending">Check Out</a>
        </div>
	</div>
