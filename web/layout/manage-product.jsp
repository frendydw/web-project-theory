...
<body>
	...
	<div class="container-fluid">
		<form action="/web-project-theory/web/layout/manage-product.jsp">
		...
		<%
			if (role != null && role.equals("admin")) {
				%>
					<div class="mt-4">
						<a href="/web-project-theory/web/layout/insert-product.jsp?id=0">
					      	...
					      	if (role != null && role.equals("admin")) {
					      		%>
					      			<td class="col-action" width="18%">
										<form class="d-inline-block" action="/web-project-theory/web/layout/insert-product.jsp">
